  ...
  return (
    <PageShell containerClassName="max-w-4xl">
      ...
      <FadeIn delay={0.15} inView={false}>
        <div className="space-y-16 text-lg text-zinc-300 leading-relaxed">
          <section>
          ...
          <section>
            <h2 className="text-2xl text-white font-bold mb-4">The Philosophy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl text-white font-bold mb-4">Global Presence</h2>

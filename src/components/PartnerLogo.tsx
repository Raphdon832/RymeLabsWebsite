      ...
      case "UrbanDev Studio":
        return (
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white text-black rounded-lg flex items-center justify-center font-bold text-xl">U</div>
            <span className="font-bold text-xl tracking-tight">UrbanDev<span className="font-light text-zinc-400">Studio</span></span>
          </div>
        );
      case "UrbanDev Games":
        return (
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl tracking-tight">UrbanDev<span className="text-purple-400">Games</span></span>
          </div>
        );
        ...
        return (
          <div className="flex items-center gap-3">
            <div className="flex -space-x-1">
                {[1,2,3].map(i => (
                    <svg key={i} className={`w-6 h-6 ${i === 2 ? 'text-yellow-400' : 'text-yellow-500/50'}`} fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                ))}
            </div>
            <div className="flex flex-col leading-none">
                <span className="font-bold text-lg">5Stars</span>
                <span className="text-xs text-zinc-500 uppercase tracking-widest">Consulting</span>
            </div>
          </div>
        );
